...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800 font-weight">공지사항 관리 - 공지사항 수정</h1>
<p class="mb-4"></p>
<form>
	<!-- DataTales Example -->
				...
				<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
					...
					<div id="add-wrapper">
						...
						<table class="add-table">
							<tr>
								<td>번호</td>
								<td>${notice.noticeNo}<input type="hidden" name="no" value="${notice.noticeNo}"></td>
							</tr>
							<tr>
								<td>공지명</td>
								<td><input type="text" name="name" id="title" value="${notice.noticeTitle }"></td>
							...
							<tr>
								...
								<td><c:if test="${notice.noticeDelYn == 'n'}">
									...
									<c:if test="${notice.noticeDelYn == 'y'}">
							...
							<tr>
								<td>공지 내용</td>
								<td><input type='text' name="content" id="noticeContent" value="${notice.noticeContent}" style="height: 60px;"></td>
							</tr>
						...
						<div class="add-buttons" style="float: right">
							...
							<input type="button" value="수정완료" id="modifyBtn" class="btn btn-primary btn-sm">
							<input type="button" value="취소"
								class="btn btn-primary btn-sm" onclick="location.href='noticeList.do'" > <input type="hidden"
