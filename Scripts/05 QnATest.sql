...
UPDATE qna SET qna_password = '123' WHERE QNA_NO = 2;
UPDATE qna SET QNA_SECRET = 'y' WHERE QNA_NO = 2;

SELECT QNA_NO,GUEST_ID,GUEST_NAME,ADMIN_ID,QNA_TITLE,QNA_CONTENT,QNA_FILE,QNA_REGDATE,RES_YN,QNA_REFNO,NOTICE_YN,DEL_YN,QNA_SECRET,QNA_PASSWORD FROM QNA q2 ;

SELECT * FROM QNA WHERE QNA_NO =19 AND QNA_PASSWORD = 123; 